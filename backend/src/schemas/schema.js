...
const email = Joi.string().email().required(),
    ...
    id_plano = Joi.number().integer().positive().allow(null).required(),
    id_treino = Joi.number().integer().positive().allow(null).required(),
    ...
    matricula = Joi.number().integer().positive().required(),
    ...
    const dias = Joi.array().items(
      ...
      module.exports = {
        ...
        s_plan: criaObjJoi({ tipo, valor, descricao, dias_validade, id_academia }),
        s_payment: criaObjJoi({ id_aluno, id_plano }),
        ...
        s_studentLogin: criaObjJoi({ nascimento, matricula, key }),
